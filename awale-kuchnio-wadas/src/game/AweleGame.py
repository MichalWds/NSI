...
from .board import print_board,deal_with_position, pick_new_position, print_board, will_starve_player
...
class AweleGame(TwoPlayerGame):
    ...
    def __init__(self, players):
        ...
        for i, player in enumerate(players):
            ...
            player.camp = i
            gamePlayers.append(self.get_complement_properties_player(i, player.score, player.isstarved,  player.camp, player.ask_move, player,))
    ...
    def get_complement_properties_player(self,number,score,isstarved, camp,ask_move, player=None):
        ...
        return PlayerData(number,number * half_pit,(1 + number) * half_pit,(1 - number) * half_pit,(2 - number) * half_pit,player, score, isstarved, camp,ask_move)
